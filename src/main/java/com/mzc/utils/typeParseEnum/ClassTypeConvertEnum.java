...
public enum ClassTypeConvertEnum {
    ...
    ENUM_BYTE(Byte.class, DB_BYTE),
    ENUM_SHORT(Short.class, DB_SHORT),
    ENUM_INTEGER(Integer.class, DB_INTEGER),
    ENUM_LONG(Long.class, DB_LONG),
    ENUM_FLOAT(Float.class, DB_FLOAT),
    ENUM_DOUBLE(Double.class, DB_DOUBLE),
    ENUM_boolean(boolean.class, DB_BOOLEAN, DB_BOOLEAN+ " NOT NULL DEFAULT '0'"),
    ENUM_byte(byte.class, DB_BYTE),
    ENUM_short(short.class, DB_SHORT),
    ENUM_integer(int.class, DB_INTEGER),
    ENUM_long(long.class, DB_LONG),
    ENUM_float(float.class, DB_FLOAT),
    ENUM_double(double.class, DB_DOUBLE),
    ;
