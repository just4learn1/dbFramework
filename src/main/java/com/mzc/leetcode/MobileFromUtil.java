...
//    正则表达式,抽取手机归属地
    ...
    public static String getMobileFrom(String mobileNumber) throws Exception {
        ...
        try {
//            String host = "https://shouji.51240.com";
...
//            client.getHostConfiguration().setHost(host, 80, "http");
            ...
            //设置编码
//            method = new PostMethod("/" + mobileNumber + "_shouji/");
            ...
            if (httpStatusCode == 301 || httpStatusCode == 302) {
                String location = method.getURI().toString();
                Header l2 = method.getResponseHeader("location");
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(getMobileFrom("18611812654"));
    }
