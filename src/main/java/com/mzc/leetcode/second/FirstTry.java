...
public class FirstTry {
    ...
    public static void main(String[] args) {
        ...
        nod.next.next.next = new ListNode(3);
        nod.next.next.next.next = new ListNode(4);
        nod.next.next.next.next.next = new ListNode(4);
        nod.next.next.next.next.next.next = new ListNode(5);
        ListNode r = deleteDuplicates(nod);
        while (r != null) {
